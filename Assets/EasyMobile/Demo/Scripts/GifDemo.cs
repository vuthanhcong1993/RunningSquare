...
namespace EasyMobile.Demo
{
    ...
    public class GifDemo : MonoBehaviour
    {
        ...
        public void ShareGiphyURL()
        {
            ...
            MobileNativeShare.ShareURL(uploadedGifUrl);
        }
        ...
        void OnGifExportCompleted(AnimatedClip clip, string path)
        {
            ...
            if (shouldUpload)
                UploadGIFToGiphy();
            #else
            MobileNativeAlert popup = MobileNativeUI.ShowTwoButtonAlert("Export Completed", "A GIF file has been created. Do you want to upload it to Giphy?", "Yes", "No");
            if (popup != null)
            {
        ...
        void OnGiphyUploadCompleted(string url)
        {
            ...
            #else
            MobileNativeAlert alert = MobileNativeUI.ShowTwoButtonAlert("Upload Completed", "The GIF image has been uploaded to Giphy at " + url + ". Open it in the browser?", "Yes", "No");
