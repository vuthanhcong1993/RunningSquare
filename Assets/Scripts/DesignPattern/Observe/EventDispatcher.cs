...
// Dùng thay thế singleton khi là các sự kiện ví dụ chết,sống,hồi máu(đối tượng trong game)...,còn lại tính toán,các chức năng(không phải đối tượng) dùng singleton
